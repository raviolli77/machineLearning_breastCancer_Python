...
#test_class_set_scaled = train_test_split(breast_cancer_norm,
#                                        test_size = 0.20,
#                                        random_state = 42)

# Cleaning test sets to avoid future warning messages
#class_set_scaled = class_set_scaled.values.ravel()
#test_class_set_scaled = test_class_set_scaled.values.ravel()

# LOAD PACKAGES
setwd('/home/rxe/myProjects/breastCancer/scripts/r')
...
breastCancer <- read_csv('wdbc.data.txt')
breast_simp <- read_csv('breast_cancer.txt')

View(inner_join(breastCancer, breast_simp, by = "id_number"))
